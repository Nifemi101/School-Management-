...
import { setNewPassword } from '@/app/actions/passwordReset'
import {
  KeyRound,
  Eye,
  EyeOff,
  ...
  useEffect(() => {
    const checkSession = async () => {
      ...
      if (!profile?.is_temp_login) {
        // Not a temp login — redirect to their dashboard
      ...
      <div className="w-full max-w-md">
        ...
        <div className="flex items-start gap-3 bg-blue-50 border border-blue-100 rounded-xl px-4 py-3 mb-6">
          ...
          <p className="text-xs text-blue-700 leading-relaxed">
            Choose a strong password you haven&apos;t used before. You won&apos;t be able to access
            your {role ?? 'account'} portal until this is done.
          </p>
        </div>
